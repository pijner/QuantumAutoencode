# -*- coding: utf-8 -*-
"""dataset testing.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1BWFTGPORXC0pvqzWaKtTezCsy7-rSybF
"""
...
# --- 2️⃣ Normalize and extract 8x8 patches ---
def preprocess_and_extract_patches(image, label):
    # Normalize to [0,1]
    image = tf.cast(image, tf.float32) / 255.0

    # Add batch dimension for tf.image.extract_patches
    ...
    patches = tf.squeeze(patches, axis=0)  # shape (num_patches_y, num_patches_x, patch_size_flat)

    # Reshape each flattened patch back to (8, 8, 1)
    patch_size = 8
...
# Example usage
for patches, label in ds_train_patches.take(1):
    print("Label:", label.numpy())
    print("Patches shape:", patches.shape)  # (number_of_patches, 8, 8, 1)
